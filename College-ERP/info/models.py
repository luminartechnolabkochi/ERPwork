...
class Course(models.Model):
    ...
    fees=models.PositiveIntegerField(default=20000,null=True)
...
#Teacher.objects.exclude(teacher__month__month=currentmonth,teacher__month__year=currentyear)
...
class Student(models.Model):
    ...
    def balance_fee(self):
        payments=self.feemanager_set.all()
        amount=0
...
class Accountant(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE, null=True,related_name="accountant")
    name = models.CharField(max_length=100)
    sex = models.CharField(max_length=50, choices=sex_choice, default='Male')
    DOB = models.DateField(default='1980-01-01')
    salary=models.PositiveIntegerField(null=True)
...
class FeeManager(models.Model):
    ...
    to_acno=models.CharField(max_length=18,null=True)
