...
urlpatterns = [
    ...
    path('add-accountant/', views.AccountantCreateView.as_view(), name='add_accountant'),
    path("employees/all",views.TeachersListView.as_view(),name="emplist"),
    path("employees/salary/payments/<str:id>",views.PayrollProcess.as_view(),name="payment"),
    path("employess/payements/list",views.PaymentList.as_view(),name="payment_list"),
    path("student/payment/home",views.FeePaymentHome.as_view(),name="pay_home"),
    path("student/fees/pay",views.MakePaymentView.as_view(),name="fees_pay"),
    path("accountant/students/collects/",views.FeesCollection.as_view(),name="collections"),
    path("accountant/students/fees/transactions/<str:USN>",views.FeeHistory.as_view(),name="fee_history")
